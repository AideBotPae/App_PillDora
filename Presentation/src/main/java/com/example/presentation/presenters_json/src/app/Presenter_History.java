...
public class Presenter_History extends Presenter {
    ...
    public Presenter_History (String user_id, Client_App client){
    ...
    */
    ...
    public Map<String, String> getHistory(String date){
        HashMap<String, String> parameters = new HashMap<String,String>();
        parameters.put("date", date);
        // Preparar la query
        String query = super.query_creator("HISTORY", parameters);
        ...
        clApp.close();
        return this.processHistory(json_response);
    }


    public Map<String, String> processHistory(String json_response){
        Map<String, String> list_map_parameters = new HashMap<String, String>();
        ...
        list_map_parameters = (Map<String, String>) params.get("history");
